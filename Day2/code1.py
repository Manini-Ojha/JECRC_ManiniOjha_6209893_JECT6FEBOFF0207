#24 Feb
list1=[1,2,3,4,5]
#homogenous list - when all the values have the same data type
#heterogenous list - a list has different data types
...
l1.insert(4,3)
print(l1)
#even if u give index greater than length of collection, it still gets executed and appends at the end
...
# list1.pop(100)
#pop takes index, prints the popped value after popping the element
